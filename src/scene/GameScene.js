phina.define("glb.GameScene", {
  ...
  init: function() {
    ...
    // glb.Mesh(
    //         glb.BoxGeometry(180),
    //         glb.BasicMaterial({ color: phina.graphics.Color(0, 128, 255, 1) })
    //     )
    ...
    //         glb.BasicMaterial({ color: phina.graphics.Color(255, 128, 0, 1) })
    //     )
    ...
    // var player = glb.Mesh(
    //         glb.PlaneGeometry(4),
    //         glb.BasicMaterial({ color: phina.graphics.Color(0, 128, 255, 1.0) })
    //     )
